      ...
      <div class="content-slider">
        <div class="slider">
          <ul>
            ...
            <li class="anim3">
              <div class="quote">
                Just when I was thinking to switch to soap bars from body wash,
                I happened to try some of them from Saka Organics and without
                any doubt, eucalyptus soap is my number 1, also for the fact
                that it acts as a soap and a exfoliator worked great for me :)
                and I highly recommend to anyone to try it atleast once.
              </div>
